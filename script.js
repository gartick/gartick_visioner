...
(function () {
  ...
  function generateMountains() {
    ...
    var shadows = [
      ...
      { src: 'mountain2.png', left: 16,  vw: 76 },
      { src: 'mountain.png',  left: 38,  vw: 51 },
      { src: 'mountain2.png', left: 60,  vw: 68 },
    ...
    var layout = [
      { src: 'mountain2.png', left: -6,  vw: 64, opacity: 0.95 },
      { src: 'mountain.png',  left: -10,   vw: 42, opacity: 1.00 },
      { src: 'mountain.png',  left: 8,   vw: 42, opacity: 1.00 },
      { src: 'mountain2.png', left: 35,  vw: 75, opacity: 0.90 },
      { src: 'mountain2.png', left: 22,  vw: 50, opacity: 0.90 },
      { src: 'mountain.png',  left: 28,  vw: 46, opacity: 1.00 },
      { src: 'mountain2.png', left: 52,  vw: 72, opacity: 0.92 },
      { src: 'mountain2.png', left: -2,  vw: 72, opacity: 0.92 },
      { src: 'mountain.png',  left: 56,  vw: 42, opacity: 0.98 },
      { src: 'mountain2.png', left: 78,  vw: 60, opacity: 0.90 },
  ...
  function generateTrees() {
    ...
    if (backContainer) {
      for (var i = 0; i < 30; i++) {
        ...
        tb.alt = '';
        tb.style.left = (i * 4.5 + (Math.random() * 4 - 2)) + '%';
        tb.style.height = (15 + Math.random() * 5) + 'vh';
    ...
    if (frontContainer) {
      for (var j = 0; j < 10; j++) {
        ...
        tf.alt = '';
        tf.style.left = (j * 8 + (Math.random() * 4 - 2)) + '%';
        tf.style.height = (21 + Math.random() * 8) + 'vh';
